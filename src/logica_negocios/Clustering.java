...
//		////los puntos amarillos de las aristas en un cluster(el cluster cambia s� encuentro
...
//	}
	...
	//Devuelve una lista de aristas ordenadas por orden de aparici�n en la lista de aristas del AGM
		...
		for(Arista arista:aristasAGM)//recorro las aristas del AGM
		{
				...
				//la lista de aristas mayores
			{
				if(arista.equals(aristaMayor))//si las dos aristas son iguales , la agrego
					//a la nueva lista(teniendo en cuenta su aparici�n)
				{
...
//	{
//		Collections.sort(aristas);//para poder utilizar Collections.sort se modific� la clase
