...
public class DAOVerticesTest
{
	...
	public void obtenerCoordenadasTest() throws IOException{
		...
		assertTrue(Double.compare(listaVertices.get(0).getLatitud(),listaVerticesDesdeJson.get(0).getLatitud())==0);
		assertTrue(Double.compare(listaVertices.get(0).getLongitud(),listaVerticesDesdeJson.get(0).getLongitud())==0);
		assertTrue(Double.compare(listaVertices.get(1).getLatitud(),listaVerticesDesdeJson.get(1).getLatitud())==0);
		assertTrue(Double.compare(listaVertices.get(0).getLongitud(),listaVerticesDesdeJson.get(0).getLongitud())==0);
